...
HD_PWD='C:/Users/thuyh/OneDrive/Documents/function/function.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_all.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_all.tcl -notrace
