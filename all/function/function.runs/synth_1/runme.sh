...
HD_PWD='C:/Users/thuyh/OneDrive/Documents/function/function.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_all.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_all.tcl
